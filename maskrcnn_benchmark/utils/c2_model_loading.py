...
@C2_FORMAT_LOADER.register("R-50-NAS")
...
@C2_FORMAT_LOADER.register("R-50-FPN-DENSEBOX")
@C2_FORMAT_LOADER.register("R-50-C3TO5")
@C2_FORMAT_LOADER.register("R-50-DFPN")
@C2_FORMAT_LOADER.register("R-101-NAS")
@C2_FORMAT_LOADER.register("R-101-FPN")
@C2_FORMAT_LOADER.register("R-101-FPN-RETINANET")
@C2_FORMAT_LOADER.register("R-152-FPN")
@C2_FORMAT_LOADER.register("R-50-Deformable_FPN-DENSEBOX")
def load_resnet_c2_format(cfg, f):
    state_dict = _load_c2_pickled_weights(f)
    conv_body = cfg.MODEL.BACKBONE.CONV_BODY
    arch = conv_body.replace("-C4", "").replace("-C5", "").replace(
        "-FPN", "").replace("-RETINANET", "").replace("-ALL2C5", "").replace(
        "-DFPN", "").replace("-NAS","").replace("-Deformable_FPN-DENSEBOX","").replace("-DENSEBOX","")
