...
# Crop size of the side of the image during testing
_C.INPUT.CROP_SIZE_TEST = -1
...
_C.MODEL.BACKBONE.SPLIT = False
_C.MODEL.BACKBONE.ENCODER_OUT_CHANNELS = (320, )
# GN for backbone
...
# ---------------------------------------------------------------------------- #
# CornerNet Options (Follow the Detectron version)
# ---------------------------------------------------------------------------- #
_C.MODEL.PANOPTIC = CN()

# This is the number of foreground classes, background is not included.
_C.MODEL.PANOPTIC.NUM_CLASSES = 133
_C.MODEL.PANOPTIC.DECODER = "none"
_C.MODEL.PANOPTIC.SEG_WEIGHT = 0.0
_C.MODEL.PANOPTIC.INS_WEIGHT = -1.0
_C.MODEL.PANOPTIC.DET_WEIGHT = 1.0
...
# ---------------------------------------------------------------------------- #
_C.SEARCH = CN()
_C.SEARCH.NUM_ARCHS = 1000
_C.SEARCH.CKPT_NAME = 'nas.pth.tar'
_C.SEARCH.N_TASKS = 2
_C.SEARCH.PREFIX_ANCHOR = False # Judge whether to precompute in dataloader
_C.SEARCH.FIX_RECALL_EVAL = False
_C.SEARCH.ONLY_TASK0 = False
_C.SEARCH.TASK0_USE_FEATURE_FROM_DISK = True
_C.SEARCH.BACKBONE_TYPE = "r50"

_C.SEARCH.DECODER = CN()
_C.SEARCH.DECODER.VERSION = 2
_C.SEARCH.DECODER.OP_SIZE = 11
_C.SEARCH.DECODER.AGG_OP_SIZE = 2
_C.SEARCH.DECODER.CONFIG = [1,2,3,4,5]
_C.SEARCH.DECODER.AGG_SIZE = 256
_C.SEARCH.DECODER.NUM_CELLS = 3
_C.SEARCH.DECODER.NUM_CTX_LAYERS = 4
_C.SEARCH.DECODER.REPEATS = 1


_C.SEARCH.SOLVER = CN()
_C.SEARCH.SOLVER.SHORTER_SIDE = (256, 320)
_C.SEARCH.SOLVER.CROP_SIZE = (256, 320)
_C.SEARCH.SOLVER.FREEZE_BN = False

_C.SEARCH.NAS_DECODER_ON = False
_C.SEARCH.NAS_HEAD_ON = False

_C.SEARCH.HEAD = CN()
_C.SEARCH.HEAD.NUM_HEAD_LAYERS = 4
_C.SEARCH.HEAD.OP_SIZE = 3
_C.SEARCH.HEAD.AGG_OP_SIZE = 2
_C.SEARCH.HEAD.REPEATS = 1
_C.SEARCH.HEAD.OUTPUT_CONCAT = False
_C.SEARCH.HEAD.WEIGHT_SHARE_SEARCH = False
...
_C.SOLVER.NUM_GPUS = 4           # used to generate fixed anchors
_C.SOLVER.USE_SYNC_BN = False    # used to controll synchronize batch normalization
